...
def save_output(image_name,pred,d_fpath):
...
def u2net_run(image_path, prediction_path):
    ...
    prediction_list = [prediction_path, ]
    ...
    for i_test, data_test in enumerate(test_salobj_dataloader):
        ...
        save_output(img_name_list[i_test], pred, prediction_list[i_test])
